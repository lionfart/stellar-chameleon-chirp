...
const EntryScreen: React.FC = () => {
  ...
  const handleStartGame = () => {
    if (playerName.trim() === '') {
      showSuccess('Please enter your name to start the game!');
      return;
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-4">
      <Card className="w-full max-w-md bg-background/90 backdrop-blur-md shadow-2xl border border-primary/30">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-bold text-white drop-shadow-lg">Princess Simge Rescue</CardTitle>
          <CardDescription className="text-muted-foreground mt-2">
            A roguelite bullet-heaven adventure!
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="playerName" className="text-lg text-white">Enter Your Name</Label>
            <Input
              id="playerName"
          ...
          <div className="space-y-3 text-sm text-muted-foreground text-center pt-4">
            <h4 className="font-semibold text-white">How to Play:</h4>
            <ul className="list-disc list-inside text-left mx-auto max-w-xs">
              <li>Move with W, A, S, D or Arrow Keys.</li>
              <li>Press SHIFT to dash.</li>
              <li>Press Q, E, R, T for abilities.</li>
              <li>Find the Vendor (gold '$' icon) and press F to open the shop.</li>
              <li>Collect letters to rescue Princess Simge!</li>
            </ul>
          </div>
        </CardContent>
      </Card>
